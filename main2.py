...
while run:
    ...
    if keys[pygame.K_LEFT] and x2 > 1:
        x2 -= speed
    if keys[pygame.K_RIGHT] and x2 < 962:
        x2 += speed
    if keys[pygame.K_UP] and y2 > 1:
        y2 -= speed
    if keys[pygame.K_DOWN] and y2 < 470:
        y2 += speed
    ...
    screen.blit(player2_stay, (x2, y2))
